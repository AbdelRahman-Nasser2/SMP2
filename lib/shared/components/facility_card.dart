...
import 'package:smp/model/field_facility.dart';
...
class FacilityCardList extends StatelessWidget {
  ...
  FacilityCardList({super.key, required this.facilities});
...
class FacilityCard extends StatefulWidget {
  ...
  FacilityCard({super.key, required this.imageIcon, required this.name});
